...
<div id="header" class="flex flex-col text-center justify-center text-white">
        <div class="flex justify-between">
            <img src="./black.svg" class=" mt-5 ml-3 w-14 h-14 sm:w-20 sm:h-20 xl:w-28 xl:h-28"/>
       ...
       <img class=" w-40 sm:w-60 h-40 sm:h-60 xl:w-72 xl:h-72 2xl:w-80 2xl:h-80 mt-4 sm:absolute sm:right-4 xl:right-20 sm:-mt-20"  src="./launching-pana.svg"/>
